...
function EmptyState() {
  ...
  return (
    <div className="flex flex-col items-center gap-1 py-6">
      ...
      <div className="text-sm font-medium text-foreground">{t("models:credentials.empty.title")}</div>
      <div className="text-sm text-muted-foreground">{t("models:credentials.empty.hint")}</div>
    </div>
  );
}
