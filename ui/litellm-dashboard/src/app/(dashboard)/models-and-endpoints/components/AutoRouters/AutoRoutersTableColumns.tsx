...
function AutoRouterRowActions({
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        aria-label={t("models:autoRouter.openActionsAria", { name: row.name })}
      ...
      <DropdownMenuContent align="end" className="w-44">
        ...
        >
          <Trash2 />
          {t("models:autoRouter.deleteAction")}
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
...
export const getAutoRoutersTableColumns = ({
...
}: AutoRoutersTableColumnsDeps): ColumnDef<AutoRouterRow>[] => [
  {
    id: "name",
    accessorKey: "name",
    meta: { title: t("models:autoRouter.columns.name") },
    header: ({ column }) => <DataTableSortHeader column={column} title={t("models:autoRouter.columns.name")} />,
    size: 260,
    enableSorting: true,
  ...
  },
  {
    id: "kind",
    accessorKey: "kind",
    meta: { title: t("models:autoRouter.columns.type") },
    header: t("models:autoRouter.columns.type"),
    size: 180,
    enableSorting: false,
  ...
  {
    id: "targets",
    meta: { title: t("models:autoRouter.columns.routesTo") },
    header: t("models:autoRouter.columns.routesTo"),
    size: 320,
    enableSorting: false,
  ...
  },
  {
    ...
    meta: { title: t("models:autoRouter.columns.defaultModel") },
    header: t("models:autoRouter.columns.defaultModel"),
    size: 200,
    enableSorting: false,
    cell: ({ row }) =>
  ...
  },
  {
    ...
    meta: { title: t("models:autoRouter.columns.created") },
    header: ({ column }) => <DataTableSortHeader column={column} title={t("models:autoRouter.columns.created")} />,
    size: 150,
    enableSorting: true,
    sortingFn: "datetime",
    sortUndefined: "last",
