  ...
  return (
    <main className="w-full p-8">
      <Tabs defaultValue="usage" onValueChange={handleTabChange} className="gap-6">
        <PageHeader
          icon={<PiggyBank />}
          title={t("cost:optimization.title")}
          subtitle={t("cost:optimization.subtitle")}
        ...
        >
          ...
          <p className="font-medium text-foreground">{t("cost:optimization.experimental")}</p>
          <p className="col-start-2 text-sm text-muted-foreground">
            {t("cost:optimization.feedbackBefore")}{" "}
            <a
            ...
            >
              {t("cost:optimization.feedbackLink")}
            </a>
          </p>
        </div>
