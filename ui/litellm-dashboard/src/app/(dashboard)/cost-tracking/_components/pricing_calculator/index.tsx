  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-end mb-2">
        ...
        >
          <label className="flex cursor-pointer items-center gap-2 text-sm">
            ...
            {t("cost:pricingCalculator.perDay")}
          </label>
          <label className="flex cursor-pointer items-center gap-2 text-sm">
            <RadioGroupItem value="month" />
            {t("cost:pricingCalculator.perMonth")}
          </label>
        </RadioGroup>
      </div>
      ...
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="w-[35%]">{t("cost:pricingCalculator.model")}</TableHead>
            ...
            <TableRow key={record.id}>
              <TableCell className="whitespace-normal">
                <SearchSelect
                  ...
                  placeholder={t("cost:pricingCalculator.selectModel")}
                />
              </TableCell>
              <TableCell>
                <Input
              ...
              <TableCell>
                <Button
                  variant="ghost"
                  size="icon-sm"
                  aria-label={t("cost:pricingCalculator.removeRowAria", { index: index + 1 })}
          ...
          <TableRow>
            <TableCell colSpan={5}>
              <Button variant="outline" onClick={handleAddEntry} className="w-full border-dashed">
                ...
                {t("cost:pricingCalculator.addAnother")}
              </Button>
            </TableCell>
          </TableRow>
        </TableFooter>
